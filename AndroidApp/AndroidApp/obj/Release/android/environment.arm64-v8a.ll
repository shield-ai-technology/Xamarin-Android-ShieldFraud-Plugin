...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"26672a20-d5a4-410b-804b-4fd89220116a\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 31, ; number_of_assemblies_in_apk
	...
	i32 100667616, ; jnienv_initialize_method_token
	i32 100667615, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.1 = internal constant [31 x i8] c"libcashshieldabc-native-lib.so\00", align 1
...
@dso_cache = local_unnamed_addr global [24 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1330373084971931059, ; hash 0x12766f45ac7e15b3, from name: libcashshieldabc-native-lib
		i8 0, ; ignore
	...
	; 1
	%struct.DSOCacheEntry {
		i64 1428422496030325178, ; hash 0x13d2c6b1291079ba, from name: cashshieldabc-native-lib
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 3
	%struct.DSOCacheEntry {
		i64 2600859398661037429, ; hash 0x24181bd7d7ed5d75, from name: cashshieldabc-native-lib.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 10
	%struct.DSOCacheEntry {
		i64 8191900834173320093, ; hash 0x71af7a67f8207b9d, from name: libcashshieldabc-native-lib.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [31 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
