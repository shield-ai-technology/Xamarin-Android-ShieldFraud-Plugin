...
@__DSOCacheEntry_name.5 = internal constant [31 x i8] c"libcashshieldabc-native-lib.so\00", align 1
...
@dso_cache = local_unnamed_addr global [24 x %struct.DSOCacheEntry] [
	...
	; 6
	%struct.DSOCacheEntry {
		i64 1711225410, ; hash 0x65ff3a42, from name: cashshieldabc-native-lib
		i8 0, ; ignore
	...
	; 7
	%struct.DSOCacheEntry {
		i64 1995017145, ; hash 0x76e98bb9, from name: libcashshieldabc-native-lib
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 14
	%struct.DSOCacheEntry {
		i64 3094137735, ; hash 0xb86ccb87, from name: libcashshieldabc-native-lib.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 23
	%struct.DSOCacheEntry {
		i64 4226096168, ; hash 0xfbe51c28, from name: cashshieldabc-native-lib.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [31 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
